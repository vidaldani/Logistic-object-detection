...
def generate_launch_description():
    ...
    # Define the node to run yolo_sam2_filter_segmentation.py
    yolo_sam2_filter_segmentation_node = Node(
        package='turtlebot3_recognition',  # Replace with your actual package name
        executable='yolo_sam2_filter_segmentation.py',
        name='yolo_sam2_filter_segmentation',
        output='screen',
        emulate_tty=True
    )
    ...
    return LaunchDescription([
        working_frame_arg,
        yolo_sam2_filter_segmentation_node,
