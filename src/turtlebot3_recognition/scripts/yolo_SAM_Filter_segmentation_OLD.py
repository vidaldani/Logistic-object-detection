...
class YoloSAMFilterSegmentationNode(Node):
    ...
    def __init__(self):
        ...
        self.sam_model = sam_model_registry["vit_b"](checkpoint="/home/tumwfml-ubunt6/SAM_models/sam_vit_b_01ec64.pth")
        ...
        self.get_logger().info("YoloSAMDepthSegmentationNode initialized.")
