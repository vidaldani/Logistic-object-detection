...
class YoloSAM2SegmentationNode(Node):

    def __init__(self):
        super().__init__('yolo_sam2_segmentation_node')
        ...
        self.get_logger().info("YoloSAM2SegmentationNode initialized.")
