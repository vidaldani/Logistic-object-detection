...
class YoloSAMSegmentationNode(Node):

    def __init__(self):
        super().__init__('yolo_sam_segmentation_node')
        ...
        self.get_logger().info("YoloSAMSegmentationNode initialized.")
